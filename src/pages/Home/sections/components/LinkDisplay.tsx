...
const PrivateLabelFrontend = () => (
  <div className="text-sm font-bold  bg-white/5 shadow-lg px-2 py-1 rounded-md  border border-white/20 backdrop-blur-md text-white/40">
    Front-End Privated
  </div>
);
        ...
        <div className="flex gap-2">
          {repoLink[0] &&
            (String(repoLink[0]).trim() === "Privated" ? (
              ...
              <div className="flex items-center gap-2 bg-white/5 shadow-lg px-2 py-1 rounded-md  border border-white/20 backdrop-blur-md hover:-translate-y-1 transition-transform duration-300 hover:text-white/80 text-white">
